...
{
    public function testit_resolves_the_manager_from_the_container(): void
    {
        $manager = $this->app->make(EasySqlManager::class);

        $this->assertInstanceOf(EasySqlManager::class, $manager);
    }
    public function testit_resolves_the_manager_via_the_easysql_alias(): void
    {
        $manager = $this->app->make("easysql");

        $this->assertInstanceOf(EasySqlManager::class, $manager);
    }
    public function testit_returns_the_default_connection_name(): void
    {
        $manager = $this->app->make(EasySqlManager::class);

        $this->assertSame("default", $manager->getDefaultConnection());
    }
    public function testit_allows_setting_the_default_connection_name(): void
    {
        $manager = $this->app->make(EasySqlManager::class);
    ...
    public function testit_throws_an_exception_for_undefined_connections(): void
    {
    ...
    public function testit_returns_a_client_instance(): void
    {
        $manager = $this->app->make(EasySqlManager::class);
    ...
    public function testit_returns_the_same_client_instance_on_subsequent_calls(): void
    {
        $manager = $this->app->make(EasySqlManager::class);
    ...
    public function testit_resolves_client_via_container(): void
    {
        $client = $this->app->make(Client::class);

        $this->assertInstanceOf(Client::class, $client);
    }
    public function testit_resolves_client_via_easysql_client_alias(): void
    {
        $client = $this->app->make("easysql.client");

        $this->assertInstanceOf(Client::class, $client);
    }
    public function testthe_facade_resolves_the_manager(): void
    {
